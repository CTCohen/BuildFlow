...
links: [[roofing-must-haves]] [[roofing-keyword-map]] [[local-seo]]
---

# Roofing structured data

## Rule
JSON-LD on every page. Sitewide type: `RoofingContractor` (a schema.org LocalBusiness subtype).
