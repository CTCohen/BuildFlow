...
applies_to: [build]
links: [[roofing-must-haves]] [[roofing-keyword-map]] [[page-services]]
---

# Roofing site page map

## Rule
Pages every roofing site generates:

| Path | Notes |
|---|---|
| `/` | home |
| `/services` | hub |
| `/services/roof-repair` | repair |
| `/services/roof-replacement` | replacement |
| `/services/leak-repair` | leak tracing |
| `/services/inspection` | inspection reports |
| `/services/storm-damage` | documentation and repair |
| `/services/maintenance` | upkeep |
