...
applies_to: [build]
links: [[electrical-must-haves]] [[anti-ai-slop-copy]]
---

# Electrical copy bank

## Rule
Copy for this trade lives in the reusable pool at `knowledge/pool/electrical.json`: per service, headline variants tagged by tone, hero sub-lines, a one-sentence blurb, a direct-answer opener, symptoms, process steps, and FAQ. Merge fields ({business}, {city}, {phone}, {areas}, {years}, {license}) are filled at build time.
